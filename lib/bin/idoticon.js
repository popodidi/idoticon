...
.option('-o, --output [outputPath]', 'Output destination, default to ./report/').option('-f, --file [fileName]', 'Output file name, default to YYYYMMDD-{identifier}').arguments('[identifier]').action(function (id) {
    identifier = id;
}).parse(process.argv);
